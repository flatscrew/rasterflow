...
namespace Babl {
	[Compact]
	[CCode (cheader_filename = "babl/babl.h", cname = "Babl")]
	public class Object {
	}
	[CCode (cheader_filename = "babl/babl.h", cprefix = "BABL_ICC_INTENT_", has_type_id = false)]
	...
	[CCode (cheader_filename = "babl/babl.h", cprefix = "BABL_MODEL_FLAG_", has_type_id = false)]
	[Flags]
	...
	[CCode (cheader_filename = "babl/babl.h", cprefix = "BABL_SPACE_FLAG_", has_type_id = false)]
	public enum SpaceFlags {
		NONE,
		EQUALIZE
	}
	[CCode (cheader_filename = "babl/babl.h", has_target = false)]
	public delegate void FishProcess (Babl.Object babl, string src, string dst, long n, void* data);
	[CCode (cheader_filename = "babl/babl.h", instance_pos = 4.9)]
	public delegate void FuncLinear (Babl.Object conversion, string src, string dst, long n);
	[CCode (cheader_filename = "babl/babl.h", instance_pos = 8.9)]
	...
	[CCode (cheader_filename = "babl/babl.h", cname = "BABL_ALPHA_FLOOR")]
	public const int ALPHA_FLOOR;
	[CCode (cheader_filename = "babl/babl.h", cname = "BABL_ALPHA_FLOOR_F")]
	public const int ALPHA_FLOOR_F;
	[CCode (cheader_filename = "babl/babl.h", cname = "BABL_MAJOR_VERSION")]
	public const int MAJOR_VERSION;
	[CCode (cheader_filename = "babl/babl.h", cname = "BABL_MICRO_VERSION")]
	public const int MICRO_VERSION;
	[CCode (cheader_filename = "babl/babl.h", cname = "BABL_MINOR_VERSION")]
	...
	[CCode (cheader_filename = "babl/babl.h")]
	public static int space_is_rgb (Babl.Object space);
	[CCode (cheader_filename = "babl/babl.h")]
